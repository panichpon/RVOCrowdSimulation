...
public class LargeSpace09 extends JPanel {
	/**
	 * 
	 */
	...
	private void updateVisualization() {
		...
		for (int agentNo = 0; agentNo < Simulator.instance.getNumAgents(); agentNo++) {
			...
			Vector2D agentPos = Simulator.instance.getAgentPosition(agentNo);
			System.out.print(Simulator.instance.getGlobalTime() + "=> " + agentPos.getX() + " "  + agentPos.getY() + " ");
		}
	...
	private void setPreferredVelocities() {
		...
		for (int agentNo = 0; agentNo < Simulator.instance.getNumAgents(); agentNo++) {
			...
			if(nearAgent > 0) {
				...
				if(goalsList.get(agentNo).getSubGoalSize() <= 0 && nearAgent > 1) {
	...
	public static void main(String[] args) {
		...
		final LargeSpace09 blocks = new LargeSpace09();
